...
public class LocalizacaoResource {
	...
	public ResponseEntity<List<Localizacao>> findAll() {	
		List<Localizacao> localizacoes = service.findAll();
	...
	public ResponseEntity<Void> insert(@RequestBody Localizacao newLoc) {
		Localizacao obj = service.insert(newLoc);
	...
	public ResponseEntity<Void> update(@Valid @RequestBody Localizacao newLoc, @PathVariable Integer id){
		Localizacao obj = service.find(id);
		service.update(newLoc, obj);
	...
	public ResponseEntity <Page<Localizacao>> findPage(
