...
public class TesteService {
	...
	public void instantiateTestDatabase() {
		...
		Long dataMili = (long) 1513616765289.0;
		
		Anuncio anuncio1 = new Anuncio(null, 490.0, "Bicleta azul", "semi nova", null, new Date(Long.parseLong("1513616765289")), null, null, null, loc2, cat1);
		Anuncio anuncio2 = new Anuncio(null, 7932.0, "CG", "125cc", null, new Date(dataMili), null, null, usr1, loc1, cat1);
		...
		Anuncio anuncio3 = new Anuncio(null, 500.0, "notebook i5 usado", "vendo urgente", null, new Date(dataMili), null, usr2, usr1, loc3, cat3);
